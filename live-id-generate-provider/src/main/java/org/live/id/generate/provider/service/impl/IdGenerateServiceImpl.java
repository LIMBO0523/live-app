package org.live.id.generate.provider.service.impl;

import jakarta.annotation.Resource;
import org.live.id.generate.provider.dao.mapper.IdBuilderMapper;
import org.live.id.generate.provider.dao.po.IdBuilderPO;
import org.live.id.generate.provider.service.IdGenerateService;
import org.live.id.generate.provider.service.bo.LocalSeqIdBO;
import org.live.id.generate.provider.service.bo.LocalUnSeqIdBO;
        ...
        try {
            ...
            if (lockStatus) {
                for (int i = 0; i < RETRY_TIMES; i++) {
                    ...
                    int result = idBuilderMapper.updateCurrentThreshold(nextThreshold,
                            currentStart, idBuilderPO.getId(), idBuilderPO.getVersion());
                    if (result < 1) {
                        continue;
                    }
